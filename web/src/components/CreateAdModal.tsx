        ...
        <form onSubmit={handleCreateAd} className='mt-8 flex flex-col gap-4'>
          <div className='flex flex-col gap-2'>
            ...
            {/* <Select.Root name='game'>
              ...
              <Select.Portal>
                <Select.Content className='bg-zinc-900 text-white rounded'>
                  <Select.Viewport>
                    {games.map((game) => (
                      <Select.Item
                        key={game.id}
                        value={game.id}
                        className='relative flex items-center py-3 px-4 rounded text-sm focus:bg-violet-500 cursor-pointer'
                      >
